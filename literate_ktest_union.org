...
We iterate in reverse when removing individual edges in order to be able to remove elements while we are iterating, otherwise we would end up removing the wrong elements and mess everything up.
