...
First, some vocabulary:
 ...
 - A distance link :: is a way to store edges common to to one particular point.
...
There are two main intuitions:
 ...
 - After the two closest points are found, a lot of now useless edges can be discarded by throwing away the distance link corresponding to those points.
...
#+name: Find the closest mergeable states
#+BEGIN_SRC ipython
while True:
